...
export const dict = {
  ro: {
    ...
    works: {
      ...
      titleA: "Lucrările",
      titleB: "noastre",
      desc: "Selecție din proiectele realizate — lavoare, blaturi și piese personalizate executate manual din colecțiile noastre premium.",
      filterAll: "Toate",
      ...
      detail: {
        ...
        relatedEyebrow: "Mai vezi și",
        relatedTitle: "Alte lucrări",
  ...
  en: {
    ...
    works: {
      ...
      titleA: "Our",
      titleB: "works",
      desc: "A selection of completed projects — washbasins, countertops and custom pieces handcrafted from our premium collections.",
      filterAll: "All",
  ...
  ru: {
    ...
    works: {
      ...
      titleA: "Наши",
      titleB: "работы",
      desc: "Подборка реализованных проектов — раковины, столешницы и индивидуальные изделия, выполненные вручную из наших премиальных коллекций.",
      filterAll: "Все",
